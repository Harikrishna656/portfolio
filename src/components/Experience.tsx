...
const experiences = [
  {
    ...
    highlights: [
      'Led full-stack development of Torus, a low-code platform serving 500+ active users, enabling anyone to build web apps via an intuitive drag-and-drop interface.',
      'Built high-performance UIs with Next.js & TypeScript and RESTful back-end services with Nest.js — reducing average page load time by 40%.',
      'Architected a multi-database layer (MySQL, PostgreSQL, MongoDB, Redis) cutting query response times by 30% through in-memory caching and session management.',
      'Delivered 10+ new features across 3 product sprints in collaboration with design, QA, and DevOps teams; streamlined CI/CD deployment pipelines.',
      'Conducted systematic code reviews and refactored legacy modules, reducing production bug count by 25% over two quarters.',
    ],
