  ...
  return (
    <section id="education" className="py-24 relative bg-[#0d0d16]">
      ...
      <div className="max-w-6xl mx-auto px-6 relative">
            ...
            {education.map((edu, i) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Center dot (desktop) */}
                  <div className={`hidden lg:flex w-5 h-5 rounded-full bg-gradient-to-br ${c.bar} border-4 border-[#0d0d16] flex-shrink-0 relative z-10`} />
        ...
        <div className="mt-16 bg-gradient-to-r from-indigo-900/30 via-purple-900/30 to-cyan-900/30 border border-indigo-500/20 rounded-2xl p-8 text-center">
          <div className="flex items-center justify-center gap-3 mb-3">
            <Award size={24} className="text-yellow-400" />
            <h3 className="text-xl font-bold text-white">Academic Achievement</h3>
          </div>
          <p className="text-slate-400 max-w-2xl mx-auto">
            Consistently maintained strong academic performance with a{' '}
            <span className="text-indigo-400 font-semibold">90% score in SSLC</span> and{' '}
            <span className="text-indigo-400 font-semibold">80% in MCA</span>, demonstrating dedication
            to excellence throughout the academic journey.
          </p>
        </div>
      </div>
    </section>
